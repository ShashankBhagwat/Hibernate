insert into Course(id,name,IS_DELETED) values (10001,'JPA',false);
...
insert into Student(id,name,passport_id) values (20001,'Shashank',40001);
insert into Student(id,name,passport_id) values (20002,'Manasa',40002);
insert into Student(id,name,passport_id) values (20003,'keerthi',40003);
